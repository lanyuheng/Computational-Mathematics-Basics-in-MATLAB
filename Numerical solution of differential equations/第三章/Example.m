...
J3=40;
N3=1600;
[U3,error3]=Backward_Euler(1,J3,N3);
J4=80;
N4=3200;
[U4,error4]=Backward_Euler(1,J4,N4);

J5=40;
N5=1600;
[U5,error5]=Crank_Nicolson(1,J5,N5);
J6=80;
N6=3200;
[U6,error6]=Crank_Nicolson(1,J6,N6);

f=figure;
colnames={'格式','h','r','x1','x2','x3','x4','误差阶'};
data = {'向前' '1/40' '1/2' U1(J1/4+1,end) U1(2*J1/4+1,end) U1(3*J1/4+1,end) U1(J1+1,end) error1;
        '    ' '1/80' '1/2' U2(J2/4+1,end) U2(2*J2/4+1,end) U2(3*J2/4+1,end) U2(J2+1,end) error2;
